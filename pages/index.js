...
export default function Home() {
  const [currentMatch, nextMatch, completedMatch, hasLiveMatch, error] =
    useWorldcupJson();
        ...
        <div className="max-w-[550px] w-full border border-dashed rounded-lg p-6">
          ...
          <div className="flex justify-between items-center gap-4">
            ...
            <div className="text-center">
              ...
              <div>
                {currentMatch.winner} {currentMatch.winner !== "Draw" && "Wins"}
              </div>
            </div>
            <div className="text-center space-y-4">
                ...
                <li key={item.id} className="flex gap-4">
                  ...
                  <div>
                    <p className="text-amber-400 text-sm">
                      {dayjs(item.datetime).format("MMMM DD")}
                    </p>
                    <div className="py-2">
                      ...
                      <p className="opacity-75">
                        ...
                        {dayjs(item.datetime).format("HH:DD")}
                      </p>
                    </div>
                  </div>
                </li>
          ...
          <div className="py-4">
                  ...
                  <li key={item.id} className="flex gap-4">
                    ...
                    <div>
                      ...
                      <div className="py-2">
                        ...
                        <p>
                          Result: {currentMatch.winner}{" "}
                          {currentMatch.winner !== "Draw" && "Wins"}
                        </p>
                        <p className="opacity-75">
            ...
            {maxCompletedMatch == 4 ? (
              <div className="w-full flex justify-center p-2">
                <button
                  onClick={() => setMaxCompletedMatch(completedMatch.length)}
